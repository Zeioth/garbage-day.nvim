...
| `notifications` | `false` | Enable to know when the clients stop/start while you are testing the plugin. It's recommended to keep this option to `false` afterwards. |
