...
* `If it doesn't work` This plugin has been tested with neovim 0.10, 0.11, 0.12 and 0.13. If you are in a neovim version superior to nvim 0.13, and it doesn't work, please [open a issue tagging me](https://github.com/Zeioth/garbage-day.nvim/issues) and I will fix it.
