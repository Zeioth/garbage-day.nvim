...
| `notifications` | `false` | Set it to `true` to get a notification every time LSP clients are stopped. It's recommended to keep this option to `false` as it can get quite annoying. |
